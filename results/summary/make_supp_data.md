...
```
    ...
    Plotting correlations of mutation escape for COV2-2955
...
![png](make_supp_data_files/make_supp_data_16_1.png)
    ...
    Saving plot to results/supp_data/COV2-2955-mutation-corr.pdf
    
    Plotting correlations of site escape for COV2-2955
...
![png](make_supp_data_files/make_supp_data_16_3.png)
    ...
    Saving plot to results/supp_data/COV2-2955-site-corr.pdf
...
```
    ...
    Raw data for COV2-2955:
    Writing to results/supp_data/COV2-2955_raw_data.csv
...
```
    ...
    Writing `dms-view` input file for COV2-2955 mapped to PDB 6m0j to results/supp_data/COV2-2955_6m0j_dms-view_data.csv
