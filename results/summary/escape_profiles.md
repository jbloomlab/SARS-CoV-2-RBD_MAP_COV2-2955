...
```
    ...
    Drawing 3 profiles using 8 CPUs...
    
    Plotted profile 1 to:
     results/escape_profiles/COV2-2955_stackedlogo.pdf
     results/escape_profiles/COV2-2955_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/COV2-2955_color_by_bind_stackedlogo.pdf
     results/escape_profiles/COV2-2955_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/COV2-2955_color_by_expr_stackedlogo.pdf
     results/escape_profiles/COV2-2955_color_by_expr_stackedlogo.png.
